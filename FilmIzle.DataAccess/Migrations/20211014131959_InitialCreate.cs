        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TRDubbing = table.Column<bool>(type: "bit", nullable: false),
                    TRDubbingUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TRSubtitle = table.Column<bool>(type: "bit", nullable: false),
                    TRSubtitleUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    IMDBPoint = table.Column<decimal>(type: "decimal(18,1)", precision: 18, scale: 1, nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Admin@gmail.com", "Admin", "123", "Admin", "admin" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CategoryFilms_FilmId_CategoryId",
                table: "CategoryFilms",
                columns: new[] { "FilmId", "CategoryId" },
                unique: true);
